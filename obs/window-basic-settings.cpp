...
void OBSBasicSettings::LoadIngestLocations() {
	...
	ui->advOutFTLIngestLoc->addItem("Europe (Milan, Italy)", QString("ingest-mil.beam.pro"));
	ui->advOutFTLIngestLoc->addItem("Europe (Paris, France)", QString("ingest-par.beam.pro"));
	ui->advOutFTLIngestLoc->addItem("Europe (Frankfurt, Germany)", QString("ingest-fra.beam.pro"));
	...
	ui->advOutFTLIngestLoc->addItem("Australia (Sydney)", QString("ingest-syd.beam.pro"));
	ui->advOutFTLIngestLoc->addItem("Mexico (Mexico City)", QString("ingest-mex.beam.pro"));
	ui->advOutFTLIngestLoc->addItem("Asia (Hong Kong, China)", QString("ingest-hkg.beam.pro"));
	ui->advOutFTLIngestLoc->addItem("Asia (Tokyo, Japan)", QString("ingest-tok.beam.pro"));
...
{
	bool usingi420 = text == "I420";

	if (usingi420)
		ui->advancedMsg2->setText(QString());
	else
		ui->advancedMsg2->setText("To correctly encode video the color format must be set to I420");
}
