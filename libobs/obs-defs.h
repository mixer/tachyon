...
/* FTL Error Codes */
#define OBS_OUTPUT_FTL_BAD_REQUEST            -1000
#define OBS_OUTPUT_FTL_UNAUTHORIZED           -1001
#define OBS_OUTPUT_FTL_OLD_VERSION            -1002
#define OBS_OUTPUT_FTL_AUDIO_SSRC_COLLISION   -1003
#define OBS_OUTPUT_FTL_VIDEO_SSRC_COLLISION   -1004
#define OBS_OUTPUT_FTL_INTERNAL_SERVER_ERROR  -1005
